...
excerpt: 'O’Donnell, F.C., Caylor, K.K., (2012) “A model-based evaluation of woody
  plant encroachment effects

  on coupled carbon and water cycles”, Journal of Geophysical Research - Biogeosciences,
  doi: 10.1029/ 2011JG001899'
header:
...
**Abstract**: … We calculate these terms recursively to represent the vertical structure of the ecosystem. … In the following sections, we describe the spatial averaging methods used to determine …
