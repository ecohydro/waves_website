...
excerpt: 'Warter, M. et al. (2023). Modeling seasonal vegetation phenology from hydroclimatic
  drivers for contrasting plant functional groups within drylands of the Southwestern
  USA. _Environmental Research: Ecology_, doi:10.1088/2752-664X/acb9a0.'
header:
...
title: Modeling seasonal vegetation phenology from hydroclimatic drivers for contrasting
  plant functional groups within drylands of the Southwestern USA
year: '2023'
---

{% include publication-feature-image.html canonical_id="Caylor2023_4247" %}
